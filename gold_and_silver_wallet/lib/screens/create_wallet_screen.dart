  ...
  Widget _buildEntropySection() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: AppTheme.space12),
        _buildStrategyCard(
          EntropyStrategy.cardShuffle,
          'Card Shuffle',
          'Shuffle a 52-card deck and record the order',
          Icons.style_rounded,
        ...
        const SizedBox(height: AppTheme.space12),
        _buildStrategyCard(
          EntropyStrategy.diceAndCard,
          'Dice & Card Hybrid',
          'Combine card shuffle and dice rolls for maximum security',
        ...
        content: const SingleChildScrollView(
          child: Column(
            ...
            mainAxisSize: MainAxisSize.min,
              ...
              Text('• Dice Rolls: Most secure - use physical 6-sided dice'),
              Text('• Card Shuffle: Shuffle a 52-card deck and record the order'),
              Text('• Dice & Card Hybrid: Combine cards and dice for maximum security'),
              SizedBox(height: 16),
              Text(
                'Mnemonic Length:',
                style: TextStyle(fontWeight: FontWeight.bold),
